...
function Items({ values }) {
  ...
  return entries.length ? <ul className="scada-analytics-list">{entries.map(([label, count]) => <li key={label}>{label} · {count}</li>)}</ul> : <p>—</p>;
}
