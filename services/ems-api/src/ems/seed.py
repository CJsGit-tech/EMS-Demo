...
async def seed_ems(session_factory=None, seed_version: int = 3) -> SeedManifest:
    ...
    counts = {"sites": 2, "assets": 4, "asset_channels": 8, "canonical_observations": day_count * 4, "quality_events": 3, "derived_metric_values": day_count * 2}
...
async def _persist_seed(session_factory, seed_version: int, manifest_hash: str) -> None:
    ...
    async with session_factory() as session:
        ...
        channels = [AssetChannel(channel_id=1001, asset_id=101, site_id=1, channel_code="ac_power_kw", channel_type="power", unit_code="kW"), AssetChannel(channel_id=1002, asset_id=101, site_id=1, channel_code="energy_kwh", channel_type="energy", unit_code="kWh"), AssetChannel(channel_id=1003, asset_id=102, site_id=1, channel_code="irradiance_w_m2", channel_type="weather", unit_code="W/m2"), AssetChannel(channel_id=1004, asset_id=102, site_id=1, channel_code="temperature_c", channel_type="weather", unit_code="C"), AssetChannel(channel_id=2001, asset_id=201, site_id=2, channel_code="ac_power_kw", channel_type="power", unit_code="kW"), AssetChannel(channel_id=2002, asset_id=201, site_id=2, channel_code="energy_kwh", channel_type="energy", unit_code="kWh"), AssetChannel(channel_id=2003, asset_id=202, site_id=2, channel_code="irradiance_w_m2", channel_type="weather", unit_code="W/m2"), AssetChannel(channel_id=2004, asset_id=202, site_id=2, channel_code="temperature_c", channel_type="weather", unit_code="C")]
        metrics = [
        ...
        for day_offset in range((FIXED_TO - FIXED_FROM).days):
            ...
            for site_id, asset_id, channel_id in ((1, 101, 1002), (2, 201, 2002)):
